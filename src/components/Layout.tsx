      ...
      {!hideHeader && (
        <header className="w-full bg-white/80 backdrop-blur-md border-b border-slate-200/50">
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2.5 text-slate-900 hover:text-slate-900 no-underline">
              <div className="w-9 h-9 rounded-lg overflow-hidden flex items-center justify-center bg-transparent border border-slate-200/50 shadow-sm" style={{ flexShrink: 0 }}>
                <Image src={logo} alt="Delphi Labs" width={36} height={36} className="object-cover scale-[1.4]" priority />
              </div>
              <span className="font-extrabold text-[15px] tracking-tight">DELPHI<span className="text-brand-500">.</span>LABS</span>
            </Link>
        ...
        <footer className="bg-[#2563EB]">
          <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center text-sm text-white">
            ...
            <div className="flex gap-6 mt-3 md:mt-0 items-center">
              ...
              <a href="https://www.instagram.com/delphilabs.in/" target="_blank" rel="noopener noreferrer" className="hover:opacity-90">Instagram</a>
